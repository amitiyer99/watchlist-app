...
function buildUniverse() {
  ...
  for (const s of b2) {
    ...
    Object.assign(r.raw, {
      ...
      volSurge: !!s.volSurgeConfirmed, b2Score: num(s.totalScore),
    });
  }
...
function computeFeatures(rec) {
  ...
  f.ret126_21  = num(x.ret126_21);   // filled by feature-lab from bars; null live
  f.ret63      = num(x.ret63);        // null live
