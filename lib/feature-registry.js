...
const REGISTRY = [
  ...
  { id: 'earnAccel',   label: 'Earnings Acceleration', block: 'quality', rationale: 'Screener.in quarterly YoY acceleration + margin expansion (CANSLIM C) — universe-wide, not Creamy-only.' },
